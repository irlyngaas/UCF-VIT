...
#SBATCH --output=/lustre/fs0/scratch/ziabariak/checkpoint/xct/diffusion/base/full_2D/XCT_NCT_All/256x256x256/N28_lr0.001_P8_BS128_ED576/inference/%x_%j.out
#SBATCH --error=/lustre/fs0/scratch/ziabariak/checkpoint/xct/diffusion/base/full_2D/XCT_NCT_All/256x256x256/N28_lr0.001_P8_BS128_ED576/inference/%x_%j.err
...
srun --mpi=pmix --container-mounts /lustre/fs0 --container-mount-home --container-image /lustre/fs0/scratch/lyngaasir/sqsh-files/0698614322576143+ucf-vit+25.05-upd3.sqsh python /home/ziabariak/git/UCF-VIT/dev_scripts/train_diffusion_fsdp_withPlots_2D.py /home/ziabariak/git/UCF-VIT/configs/xct/diffusion/base_config_dgx_2D.yaml
