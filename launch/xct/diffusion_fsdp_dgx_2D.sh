...
#SBATCH --output=/lustre/fs0/scratch/ziabariak/checkpoint/xct/diffusion/base/full_2D/XCT_Conc/600Vols/256x256x256/N4_Adaptivelr0.002_P8_BS512_ED576/inference/%x_%j.out
#SBATCH --error=/lustre/fs0/scratch/ziabariak/checkpoint/xct/diffusion/base/full_2D/XCT_Conc/600Vols/256x256x256/N4_Adaptivelr0.002_P8_BS512_ED576/inference/%x_%j.err
