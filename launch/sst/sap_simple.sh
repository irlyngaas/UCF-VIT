...
#conda activate /lustre/orion/stf006/proj-shared/irl1/forge-vit
...
python ../../dev_scripts/train_sap_simple.py ../../configs/sst/sap/base_config3D.yaml
#python ../../dev_scripts/train_sap_simple.py ../../configs/sst/sap/base_config.yaml
