    ...
    for epoch in range(epoch_start,max_epochs+1):
        ...
        if epoch % 100 == 0:
            for var in default_vars:
                ...
                save_intermediate_data(model, var, device, tile_size, precision_dt, patch_size, epoch=epoch, num_samples=2, twoD=twoD, save_path=inference_path, num_time_steps=num_time_steps)
