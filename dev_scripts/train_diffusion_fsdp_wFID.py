...
from UCF_VIT.ddpm.ddpm import DDPM_Scheduler, sample_images
...
##############################################################################################################
    ...
    best_fid = float("inf")
    fid_epochs_without_improvement = 0
    fid_patience = 4
    fid_patience_inc_rate = 1.25
    fid_max_patience = 20
    fid_decay_factor = 0.5
    fid_lr_decay_count = 0
    fid_eval_period = 10
